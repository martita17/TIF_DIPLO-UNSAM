...
<br>
La base obtenido con los vectores calculados para cada una de las notas del tópico 4 nos servirá también para entrenar el resto de los modelos. Lo mismo pasará con lo sets de entrenamiento y testeo que generaremos a continuación a partir del tópico en cuestión.
```{r}
set.seed(664)

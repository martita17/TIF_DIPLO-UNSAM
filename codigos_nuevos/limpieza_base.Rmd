...
La primera parte de la limpieza se centrará en detectar observaciones que por algún motivo resulte conveniente eliminar de la base: porque están duplicadas, porque el texto de la noticia se ha perdido, por algún problema durante el scraping, etc. Esta primera limpieza resultará últil, a su vez, para conocer con mayor profundidad la estructura de la base de datos y sus características.
...
corpus_original <- read.csv(file = "bases/2024 M5_corpus_medios.csv")
corpus_original <- as_tibble(corpus_original)
